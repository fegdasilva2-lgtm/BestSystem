...
import { renderMeasurements, wireMeasurements } from "./measurements.js";
import { renderPmoc, wirePmoc } from "./pmoc.js";
...
export function render() {
  ...
  if (state.activeView === "measurements") wireMeasurements();
  if (state.activeView === "pmoc")        wirePmoc();
}
...
// renderMeasurements antigo foi removido. Agora vive em ./measurements.js.
