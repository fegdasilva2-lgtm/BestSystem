  ...
  return (
    <main className="page-shell">
      <header className="page-header">
        ...
        <h1>Novo contrato.</h1>
        <p>
          Entidade central do PredialOps. Tudo (sites, ativos, OS, medicao, RGM) se vincula a um contrato.
        </p>
      </header>
      ...
      >
        <Section title="Identificacao">
          ...
          <Field name="code" label="Codigo do contrato" placeholder="CT-2026-099" required />
          <Field name="scope" label="Escopo" placeholder="Manutencao predial e PMOC" required />
          <TextArea name="exclusions" label="Exclusoes" placeholder="Sistemas nao cobertos, restricoes, etc." />
        </Section>

        <Section title="Vigencia e valor">
          <Field name="starts_on" label="Inicio" type="date" required />
        ...
        <Section title="Reajuste">
          <Select name="index_name" label="Indice">
          ...
          <Field name="index_date" label="Data do proximo reajuste" type="date" />
        </Section>

        <Section title="Medicao e RGM">
          <Select name="billing_rule" label="Regra de medicao">
            <option>Mensal por OS aprovada</option>
            <option>Fixo + variavel por evento</option>
